...
5. Analyze the model 
	* Compare to what data exists 
	* Look at extreme values
6. Try to answer your question
7. Go back, consider you assumptions with the goal of making your model better
...
###### Homework
Skim [Tales From The Crypt](https://www.researchgate.net/publication/5968506_Examples_of_Mathematical_Modeling_Tales_from_the_Crypt) and identify the parts of the mathematical modeling process.